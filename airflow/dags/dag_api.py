...
from paso_api_raw import ejecutar_api_raw


ARCHIVO_DEFAULT = "ny_surplus_real_estate_sales_api"
...
def tarea_raw(**context):
    ...
    resultado = ejecutar_api_raw(nombre_archivo)
    if resultado != 0:
...
with DAG(
    dag_id="dag_load_api",
    description="Pipeline API REST paginada",
